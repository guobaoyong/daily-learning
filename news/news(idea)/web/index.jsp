...
<body>
<div class="container">
    <jsp:include page="/page/forground/common/head.jsp"></jsp:include>
    <div class="row-fluid">
        <!--轮播 -->
        <div class="span9">
            <div>
    ...
    <c:forEach var="allIndexNews" items="${allIndexList }" varStatus="allStatus">
        ...
        <c:forEach var="indexNews" items="${allIndexNews }" varStatus="oneStatus">
            ...
            <li><fmt:formatDate value="${indexNews.publishDate }" type="date" pattern="yyyy-MM-dd"/>&nbsp;<a href="news?action=show&newsId=${indexNews.newsId }" title="${indexNews.title }">${fn:substring(indexNews.title,0,18) }</a></li>
    ...
    <jsp:include page="/page/forground/common/link.jsp"></jsp:include>
    <jsp:include page="/page/forground/common/foot.jsp"></jsp:include>
</div>
