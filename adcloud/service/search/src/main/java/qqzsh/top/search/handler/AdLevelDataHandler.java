package qqzsh.top.search.handler;

import com.alibaba.fastjson.JSON;
import lombok.extern.slf4j.Slf4j;
import qqzsh.top.common.dump.table.*;
import qqzsh.top.search.index.DataTable;
import qqzsh.top.search.index.IndexAware;
import qqzsh.top.search.index.adplan.AdPlanIndex;
import qqzsh.top.search.index.adplan.AdPlanObject;
import qqzsh.top.search.index.adunit.AdUnitIndex;
import qqzsh.top.search.index.adunit.AdUnitObject;
import qqzsh.top.search.index.creative.CreativeIndex;
import qqzsh.top.search.index.creative.CreativeObject;
import qqzsh.top.search.index.creativeunit.CreativeUnitIndex;
import qqzsh.top.search.index.creativeunit.CreativeUnitObject;
import qqzsh.top.search.index.district.UnitDistrictIndex;
import qqzsh.top.search.index.interest.UnitItIndex;
import qqzsh.top.search.index.keyword.UnitKeywordIndex;
import qqzsh.top.search.mysql.constant.OpType;
import qqzsh.top.search.utils.CommonUtils;
