...
Page({
  ...
  onLoad: function (params) {
    ...
    // 调用后端
    wx.request({
      url: serverUrl + '/user/query?userId=' + userId + '&publisherId=' +user.id ,
      method: "POST",
      header: {
      ...
      success: function (res) {
        ...
        if (res.data.status == 200) {
          ...
          if (userInfo.face_image != null && userInfo.face_image != '' && userInfo.face_image != undefined) {
            faceUrl = serverUrl + userInfo.face_image;
          }

          me.setData({
            faceUrl: faceUrl,
            fansCounts: userInfo.fans_counts,
            followCounts: userInfo.follow_counts,
            receiveLikeCounts: userInfo.receive_like_counts,
  ...
  followMe: function (e) {
    ...
    var url = '';
    if (followType == '1') {
      url = '/user/beyourfans?userId=' + userId + '&fanId=' + publisherId;
    } else {
      url = '/user/dontbeyourfans?userId=' + userId + '&fanId=' + publisherId;
    }
  ...
  getMyVideoList: function (page) {
    ...
    var serverUrl = app.serverUrl;
    wx.request({
      url: serverUrl + '/video/showOwn?pageNum=' + page +'&pageSize = 6'
  ...
  getMyLikesList: function (page) {
    ...
    var serverUrl = app.serverUrl;
    wx.request({
      url: serverUrl + '/video/showMyLike/?userId=' + userId + '&pageNum=' + page + '&pageSize=6',
      method: "POST",
      header: {
        'content-type': 'application/json' // 默认值
      },
  ...
  getMyFollowList: function (page) {
    ...
    var serverUrl = app.serverUrl;
    wx.request({
      url: serverUrl + '/video/showMyFollow/?userId=' + userId + '&pageNum=' + page + '&pageSize=6',
      method: "POST",
      header: {
        'content-type': 'application/json' // 默认值
      },
