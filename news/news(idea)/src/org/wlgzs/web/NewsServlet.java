...
public class NewsServlet extends HttpServlet{
	...
	private void newsList(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			request.setAttribute("mainPage", "/page/forground/news/newsList.jsp");
			request.getRequestDispatcher("/page/forground/newsTemp.jsp").forward(request, response);
		}catch(Exception e){
			e.printStackTrace();
		}finally{
			try {
	...
	private void newsShow(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			request.setAttribute("mainPage", "/page/forground/news/newsShow.jsp");
			request.getRequestDispatcher("/page/forground/newsTemp.jsp").forward(request, response);
		}catch(Exception e){
			e.printStackTrace();
		}finally{
	...
	private void newsPreSave(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			request.setAttribute("mainPage", "/page/background/news/newsSave.jsp");
	...
	private void newsBackList(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			request.setAttribute("mainPage", "/page/background/news/newsList.jsp");
			request.getRequestDispatcher("/page/background/mainTemp.jsp").forward(request, response);
		}catch(Exception e){
			e.printStackTrace();
		}finally{
