...
public class ClientUploader {
    ...
    public String uploadFile(String filePath) {
        ...
        try {
            ...
            ossClient.putObject(uploadCredentials.getUploadBucket(), object, inputStream, meta);
            ...
            if (inputStream != null) {
                try {
                    ...
                    log.error("close file input stream fail.", e);
                }
            }
        }
    }
    ...
    public String uploadBytes(byte[] bytes) {
        ...
        try {
            ...
            ossClient.putObject(uploadCredentials.getUploadBucket(), object, new ByteArrayInputStream(bytes));
            return "oss://" + uploadCredentials.getUploadBucket() + "/" + object;
        } catch (Exception e) {
            throw new RuntimeException("upload file fail.", e);
        } finally {
    ...
    private UploadCredentials getCredentialsFromServer() throws Exception {
        UploadCredentialsRequest uploadCredentialsRequest = getUploadCredentialsRequest();
    ...
    private @NotNull UploadCredentialsRequest getUploadCredentialsRequest() {
