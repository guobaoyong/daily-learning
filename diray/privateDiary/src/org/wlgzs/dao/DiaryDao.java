...
import org.wlgzs.model.Diary;
import org.wlgzs.model.PageBean;
...
public class DiaryDao {
	...
	public List<Diary> diaryCountList(Connection con)throws Exception{
		...
		String sql="SELECT DATE_FORMAT(releaseDate,'%Y年%m月') as releaseDateStr ,COUNT(*) AS diaryCount  FROM t_diary GROUP BY DATE_FORMAT(releaseDate,'%Y��%m��') ORDER BY DATE_FORMAT(releaseDate,'%Y��%m��') DESC;";
