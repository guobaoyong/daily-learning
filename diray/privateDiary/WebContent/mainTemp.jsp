...
<title>私人日志系统|主页</title>
<link href="${pageContext.request.contextPath}/css/diary.css" rel="stylesheet">
        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li class="active"><a href="exit?action=exit"><i class="icon-user"></i>&nbsp;退出</a></li>
            </ul>
          </div>
