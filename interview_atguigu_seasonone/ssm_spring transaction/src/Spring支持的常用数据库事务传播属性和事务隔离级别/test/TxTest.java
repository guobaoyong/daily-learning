package Spring支持的常用数据库事务传播属性和事务隔离级别.test;

import java.util.ArrayList;
import java.util.List;

import Spring支持的常用数据库事务传播属性和事务隔离级别.tx.dao.BookShopDao;
...
class TxTest {
	...
	//创建IOC容器对象
	ApplicationContext ioc = new ClassPathXmlApplicationContext("Spring支持的常用数据库事务传播属性和事务隔离级别/beans-tx.xml");
